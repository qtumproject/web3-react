...
The documentation that follows is for `@qtum-web3-react/core`, the package responsible for managing this context. To understand where the data itself comes from, head over to the [connectors/ folder](./connectors/).
...
#### Example
```javascript
import { Web3ReactProvider } from '@qtum-web3-react/core'
...
#### Example
```javascript
import { useWeb3React } from '@qtum-web3-react/core'
...
#### Example
```javascript
import { Web3ReactProvider, createWeb3ReactRoot } from '@qtum-web3-react/core'
// import your favorite web3 convenience library here
...
#### Example
```javascript
import { getWeb3ReactContext } from '@qtum-web3-react/core'
...
#### Example
```javascript
import { UnsupportedChainIdError } from '@qtum-web3-react/core'
// ...
